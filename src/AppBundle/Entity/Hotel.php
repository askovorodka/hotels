...
class Hotel
{
     ...
     * @var string|null
     *
     * @ORM\Column(name="label_text", type="string", nullable=true)
     * @Groups({
     *     "hotel_SAVE",
     *     "hotel_GET",
     * })
     ...
     * @var string|null
     *
     * @ORM\Column(name="label_color", type="string", nullable=true)
     * @Groups({
     *     "hotel_SAVE",
     *     "hotel_GET",
     * })
     ...
     * @return Hotel
     */
    public function setLabelText(?string $labelText): Hotel
    {
     ...
     * @return Hotel
     */
    public function setLabelColor(?string $labelColor): Hotel
    {
